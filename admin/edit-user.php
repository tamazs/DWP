...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE `User` SET `userName`='$userName', `firstName`='$firstName', `lastName`='$lastName', `email`='$email', `description`='$description', `postalCode`='$postalCode', `origin`='$origin', `roleID`='$roleID' WHERE userID='$userID'";
                    ...
                    <div class="middle-wrap">
                        <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                            <div class="card-body p-4 w-100 bg-current border-0 d-flex rounded-3">
                                <a href="../admin/admin-dashboard.php" class="d-inline-block mt-2"><i class="ti-arrow-left font-sm text-white"></i></a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="description" class="form-control" spellcheck="false" value="<?php echo $data['description']?>">
                                        </div>        
                                    </div>
